...
## divides the graphics device in 4. The figures will be drawn by column:
## first(1,1), second(2,1), third(1,2) and fourth(2,2)
par(mfcol = c(2, 2))

## creates the plot of Global Active Power
...
## creates the plot of Voltage
plot(x, as.numeric(interesting_data$Voltage), xlab = "datetime", 
     ylab = "Voltage", type = "l")

## creates the plot of Global_reactive_power
plot(x, as.numeric(interesting_data$Global_reactive_power), 
